...
<body>
	...
	<script type="text/javascript">
		// 转账
		function transfer() {
			document.location = "vipTransfer.jsp";
		}

		//修改密码
		function changePassword() {
			document.location = "vipChangePassword.jsp";
		}
		...
		function deposit() {
			document.location = "vipDeposit.jsp";
		}

		function withdraw() {
			document.location = "vipWithdraw.jsp";
		}
	</script>
</body>
</html>